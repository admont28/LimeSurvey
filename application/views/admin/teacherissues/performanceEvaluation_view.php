...
<script type="text/javascript">
    jQuery(function($) {
            ...
            swal({
              title: '¿Eliminar?',
              text: "¿Realmente está seguro de eliminar la evaluación de desempeño? Esta acción no se podrá deshacer.",
              type: 'warning',
        ...
        jQuery(document).on("change", '#pageSize', function(){
            $.fn.yiiGridView.update('evaluation-grid',{ data:{ pageSize: $(this).val() }});
        });
    });
