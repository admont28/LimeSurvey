...
<div id="edittxtele-<?php echo $i;?>" class="tab-pane fade in <?php if($i==0){echo "active";}?> center-box">
    ...
    <div class="form-group">
        <label class="col-sm-3 question-group-title control-label" for="short_title<?php echo $esrow['surveyls_language']; ?>">
            <?php eT("Survey title"); ?>:
        </label>
        <div class="col-sm-9">
    ...
    <!-- Description -->
    <div class="form-group">
        <label class="col-sm-3 control-label"  for="description_<?php echo $esrow['surveyls_language']; ?>"><?php eT("Description:"); ?></label>
        <div class="col-sm-9">
    ...
    <!-- Welcome message -->
    <div class="form-group">
        <label class="col-sm-3 control-label" for='welcome_<?php echo $esrow['surveyls_language']; ?>'><?php eT("Welcome message:"); ?></label>
        <div class="col-sm-9">
        <div class="htmleditor input-group">
    ...
    <!-- End message -->
    <div class="form-group">
        <label class="col-sm-3 control-label" for='endtext_<?php echo $esrow['surveyls_language']; ?>'><?php eT("End message:"); ?></label>
        <div class="col-sm-9">
        <div class="htmleditor input-group">
    ...
    <!-- End URL -->
    <div class="form-group">
        <label class="control-label col-sm-3"><?php eT("End URL:"); ?></label>
        <div class="col-sm-9">
    ...
    <!-- URL description -->
    <div class="form-group">
        <label class="control-label col-sm-3"><?php eT("URL description:"); ?></label>
        <div class="col-sm-9">
    ...
    <!-- Date format -->
    <div class="form-group">
        <label class="control-label col-sm-3"><?php eT("Date format:"); ?></label>
    ...
    <!-- Decimal mark -->
    <div class="form-group">
        <label class="control-label col-sm-3"><?php eT("Decimal mark:"); ?></label>
        <div class="col-sm-9">
