        ...
        <div class="col-lg-12">
            <div class="form text-right">
                ...
                <?php $form=$this->beginWidget('CActiveForm', array(
                    'action' => Yii::app()->createUrl('admin/survey/sa/listmysurveys/'),
                    'method' => 'get',
                    'htmlOptions'=>array(
                        'class'=>'form-inline',
                    ),
                ...
                <a href="<?php echo Yii::app()->createUrl('admin/survey/sa/listmysurveys');?>" class="btn btn-warning"><?php eT('Reset');?></a>
